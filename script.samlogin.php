...
class Com_SamloginInstallerScript {
    ...
    public function fixSendSystemEmailIssue() {
        // get all admin users
        $howmany = 0;
    ...
    private function installationResults($status) {
        ...
        <?php if (count($status->confpreserved)): ?>
            ...
            <?php endforeach; ?>
                <?php endif; ?>
                <?php
                $howmany = $this->fixSendSystemEmailIssue();
                if ($howmany) {
                    ?>
                 <!--   <tr style='color:red;' class="row<?php echo( ++$rows % 2); ?>">
                        <td class="key">sendEmail issue fixed</td>
                        <td class="key"> how many affected </td>
                        <td><strong><?php echo $howmany; ?></strong></td>
                    </tr> -->
        <?php }
        ?>
            </tbody>
