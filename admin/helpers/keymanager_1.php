...
$phpseclibPath = JPATH_COMPONENT_ADMINISTRATOR . "/libs/phpseclib/phpseclib-2.0/";
/*
set_include_path(get_include_path() . PATH_SEPARATOR . $phpseclibPath);
include_once( $phpseclibPath."Crypt/RSA.php");
include_once( $phpseclibPath. "Crypt/Hash.php");
include_once($phpseclibPath. "File/X509.php");
include_once($phpseclibPath. "Math/BigInteger.php");
...
// Returns : -array of strings each containing a certificate
    ...
    static function genkey($app) {
        if (SAMLoginControllerAjax::aquireLock("nosimulate")) {
            ...
            $CAPrivKey = new \phpseclib\Crypt\RSA();
