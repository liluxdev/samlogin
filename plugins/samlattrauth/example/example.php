 ...
 */
class plgSamlattrauthExample extends JPlugin {
   
    private static $fetchedAttrPrefix = "attribute_authority_example";

    public function plgSamlattrauthExample(&$subject, $config) {
    ...
    public function onAfterSAMLoginLoggedIn(&$user,$samloginAttributes,$samlNameId,$samloginparams){
        ...
        //Remember to do $user->save() if you modified something in the user object
    }
